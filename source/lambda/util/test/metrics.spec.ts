...
describe('getOptions', () => {
    ...
    test('Both environment variables are present', () => {
        expect.assertions(1);
        const metrics = require('../metrics');
        const options = metrics.getOptions();
        expect(options).toEqual({ customUserAgent: 'AwsSolution/solution-id/solution-version' });
    });

    test('One environment variable is not present', () => {
        expect.assertions(1);
    ...
    test('Both environment variables are not present', () => {
        expect.assertions(1);
    ...
    test('Solution ID is whitespace', () => {
        expect.assertions(1);
    ...
    test('Solution Version is whitespace', () => {
        expect.assertions(1);
